  ...
  return (
    <>
      <div className="flex h-screen">
        <div className="left w-1/2 overflow-y-auto">
          <div className="top-7 left-10 fixed">
            <svg
              height="100%"
              viewBox="0 0 80 17"
              fill="none"
          ...
          <div className="flex flex-col pb-25 mt-[13vh] items-center w-[70%] mx-auto gap-10">
            <div className="flex flex-col items-center justify-centre gap-3">
              <h1 className="text-3xl font-bold">Join Linktree</h1>
            ...
            />
            <button className="bg-black ring-1 text-white w-full px-3 py-3 font-bold rounded-lg">
              <Link href={"/"}>Continue</Link>
            </button>
            <p className="text-gray-600 text-center text-sm">
              By clicking <b>Create account</b>, you agree to Linktree's <a className="underline" href="/"> privacy notice</a>, <a className="underline" href="/">T&Cs</a> and to receive offers, news and updates.
            </p>
